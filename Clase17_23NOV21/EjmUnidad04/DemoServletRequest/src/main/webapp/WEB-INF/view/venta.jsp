	...
	<div class="container">
		...
		<c:if test="${datos != null}">
			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="procesar6">
				...
				<div class="card-body">
					<form method="get" action="home">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<fmt:formatNumber type="number" maxFractionDigits="2"
									minFractionDigits="2" value="${ventaDto.precio}" />
							</div>
						</div>
						...
						<div class="form-group row">
							<label for="cantidad" class="col-sm-2 col-form-label">Cantidad</label>
							<div class="col-sm-10">
								<fmt:formatNumber type="number" value="${ventaDto.cantidad}" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<fmt:formatNumber type="number" maxFractionDigits="2"
									minFractionDigits="2" value="${ventaDto.importe}" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<fmt:formatNumber type="number" maxFractionDigits="2"
									minFractionDigits="2" value="${ventaDto.impuesto}" />
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<fmt:formatNumber type="number" maxFractionDigits="2"
									minFractionDigits="2" value="${ventaDto.total}" />
							</div>
						</div>
